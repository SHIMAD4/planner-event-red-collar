...
export const Arrow = withDefaultProps(({ size, fill, ...props }) => (
    ...
    >
        <path
            d="M2 2L11.2929 11.2929C11.6834 11.6834 11.6834 12.3166 11.2929 12.7071L2 22"
            stroke="#0D0C0C"
            strokeWidth="4"
            strokeLinecap="round"
        />
...
export const Clear = withDefaultProps(({ size, fill, ...props }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M16 15L11.5 10.5L10 12L14.5 16.5L10 21L11.5 22.5L16 18L20.5 22.5L22 21L17.5 16.5L22 12L20.5 10.5L16 15Z"
            fill="#B3B3BC"
        />
    </svg>
));
...
export const Close = withDefaultProps(({ size, fill, ...props }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M31.3139 11.5147L28.4855 8.68629L20.0002 17.1716L11.515 8.68629L8.68652 11.5147L17.1718 20L8.68652 28.4853L11.5149 31.3137L20.0002 22.8284L28.4855 31.3137L31.3139 28.4853L22.8287 20L31.3139 11.5147Z"
            fill="#B3B3BC"
        />
    </svg>
));
...
export const Info = withDefaultProps(({ size, fill, ...props }) => (
    ...
    >
        <path
            fillRule="evenodd"
            clipRule="evenodd"
            d="M12 21C16.9706 21 21 16.9706 21 12C21 7.02944 16.9706 3 12 3C7.02944 3 3 7.02944 3 12C3 16.9706 7.02944 21 12 21ZM13.0078 8.87818C13.0078 9.15432 12.784 9.37818 12.5078 9.37818H11.4924C11.2163 9.37818 10.9924 9.15432 10.9924 8.87818V8.18726C10.9924 7.91111 11.2163 7.68726 11.4924 7.68726L12.5078 7.68725C12.784 7.68725 13.0078 7.91111 13.0078 8.18725V8.87818ZM12.9598 15.8128C12.9598 16.089 12.7359 16.3128 12.4598 16.3128H11.5288C11.2527 16.3128 11.0288 16.089 11.0288 15.8128L11.0288 11.4367C11.0288 11.1606 11.2527 10.9367 11.5288 10.9367H12.4598C12.7359 10.9367 12.9598 11.1606 12.9598 11.4367L12.9598 15.8128Z"
            fill="#0D0C0C"
        />
    </svg>
));
...
export const Logo = withDefaultProps(({ size, fill, ...props }) => (
    ...
    >
        <path
            d="M26.4315 14.3425L49.9492 3.20801L52.967 6.22578L34.7563 26.1014L26.4315 17.8806L18.2107 26.1014L0 6.22578L3.01777 3.20801L26.4315 14.3425Z"
            fill="#F51B1B"
        />
    </svg>
));
